...
//console.log(Vue.prototype.OSS,2222)
...
Axios.defaults.baseURL = "http://192.168.0.178:8088"

Axios.defaults.headers.common['Authorization'] ="Basic "+window.btoa("zhaoshengbao"+":"+"123"),
