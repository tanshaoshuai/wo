<template>
	<div class='sorcePool'>
		...
		<el-table :data="tableData" border style="width: 100%">
			...
			<el-table-column prop="from" label="来源" width="">
			</el-table-column>
			<el-table-column prop="name" label="封面" width="">
			</el-table-column>
			<el-table-column prop="type" label="类型" width="">
			</el-table-column>
			<el-table-column prop="putDate" label="创建时间" width="">
			</el-table-column>
			<el-table-column prop="containt" label="内容" width="">
				<template slot-scope="scope">
					<a :href="'http://'+scope.row.containt" target="_blank" class="buttonText">{{scope.row.containt}}</a>
				</template>
			</el-table-column>
